#
#  Be sure to run `pod spec lint BespotSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #spec.pod_target_xcconfig = { "GCC_PREPROCESSOR_DEFINITIONS" => "BESPOT_SDK_VERSION=\@\"0.4.9\"" }
